                ...
                <main className="content">
                    <div className="container-fluid p-0">
                        <div className="card-header p-3 illustration d-flex justify-content-between align-items-center">
                            <h1 className="text-white mb-0">Orders Details</h1>
                            <div className="d-flex gap-2">
                                <Link to="/AdminOrders" className="btn btn-light">Back</Link>
                                <Link to="/AdminOrdersDetailsPrint" className="btn btn-light text-info">Print</Link>
                            </div>
                        </div>
                    </div>
                    <div className="card">
